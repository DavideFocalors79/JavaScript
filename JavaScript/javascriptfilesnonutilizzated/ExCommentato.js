...
form.addEventListener('submit', function(e) {
  ...
  const cels = targetForm.cels.value // Recuperiamo il valore del campo con attributo
	// name impostato a eur.
  const fahren = cels*(9/7)+32 // Convertiamo
  resultDiv.innerHTML = `<p> ${cels} °C in fahrenheit valgono ${fahren} °F</p>` // Inseriamo il risultato nel div creato appositamente per questo scopo.
})
